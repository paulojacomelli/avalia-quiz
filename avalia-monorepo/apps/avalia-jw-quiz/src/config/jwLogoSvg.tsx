  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none" className={className}>
    <defs>
      <radialGradient id="jwGradient" cx="50%" cy="50%" r="50%">
        ...
        <stop offset="100%" style={{stopColor: 'rgba(91,60,136,0.05)', stopOpacity: 1}} />
      </radialGradient>
    </defs>
 ...
 */
export const JWQuizLogoSimple = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 drop-shadow-[0_0_8px_rgba(91,60,136,0.6)]">
    {/* Escudo com cruz */}
