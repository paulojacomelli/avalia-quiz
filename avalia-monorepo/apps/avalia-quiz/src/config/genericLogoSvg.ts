...
export const GENERIC_QUIZ_LOGO_SVG = `
 ...
 */
export const GENERIC_QUIZ_LOGO_TECH = `
 ...
 */
export const GENERIC_QUIZ_LOGO_PREMIUM = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none">
  <defs>
    <radialGradient id="genericGradient" cx="50%" cy="50%" r="50%">
      <stop offset="0%" style="stop-color:rgba(66,135,245,0.2);stop-opacity:1" />
      <stop offset="100%" style="stop-color:rgba(66,135,245,0.05);stop-opacity:1" />
    </radialGradient>
  </defs>
