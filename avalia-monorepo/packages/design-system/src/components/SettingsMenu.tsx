                        ...
                        <div className="flex flex-col gap-2 p-3 bg-black/20 rounded-xl mt-1">
                            ...
                            <div className="grid grid-cols-2 gap-1">
                                <button
                                    ...
                                    className={`text-[10px] py-2 rounded-lg font-bold border transition-all ${interfaceLanguage === 'pt' ? 'bg-jw-blue border-jw-blue text-white shadow-lg' : 'bg-white/5 border-transparent text-gray-400 hover:bg-white/10'}`}
                                >
                                    Português
                                </button>
                                <button
                                    onClick={() => handleAction(() => onLanguageChange('libras'))}
                                    className={`text-[10px] py-2 rounded-lg font-bold border transition-all ${interfaceLanguage === 'libras' ? 'bg-jw-blue border-jw-blue text-white shadow-lg' : 'bg-white/5 border-transparent text-gray-400 hover:bg-white/10'}`}
                                >
                                    Libras
                                </button>
                            </div>
