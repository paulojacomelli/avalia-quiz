...
type SettingsMenuProps = {
    ...
    onLanguageChange: (lang: 'pt' | 'libras') => void;
};
    ...
    return (
        <div ref={rootRef} className="relative">
            <button
                ...
                title="Configurações"
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-6 h-6 transition-transform duration-300 ${open ? 'rotate-90 text-brand-blue' : ''}`}>
            ...
            {open && (
                <div
                    ...
                    className="absolute top-full right-0 mt-2 min-w-[280px] bg-brand-card border border-gray-700/50 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] p-2 z-[100] animate-fade-in origin-top-right backdrop-blur-md"
                >
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center justify-between px-4 py-3 rounded-xl bg-black/20 mt-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[11px] font-mono w-10 text-center text-brand-blue font-bold">{Math.round(zoomValue * 100)}%</span>
                                <button
