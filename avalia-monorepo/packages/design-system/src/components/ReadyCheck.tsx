        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-fade-in p-4">
            <div className="bg-[#1e1e1e] p-8 rounded-2xl shadow-2xl text-center border border-gray-800 max-w-sm w-full flex flex-col items-center">
                ...
                {!isLive || livePhase === 'idle' ? (
                    <div className="w-12 h-12 rounded-full border-2 flex items-center justify-center mb-6 shadow-lg" style={{ borderColor: 'var(--accent-primary, #4287f5)', color: 'var(--accent-primary, #4287f5)', boxShadow: '0 0 15px color-mix(in srgb, var(--accent-primary, #4287f5) 30%, transparent)' }}>
                    ...
                    <div className="w-12 h-12 rounded-full border-2 border-t-transparent flex items-center justify-center mb-6 animate-spin" style={{ borderColor: 'color-mix(in srgb, var(--accent-primary, #4287f5) 30%, transparent)', borderTopColor: 'var(--accent-primary, #4287f5)' }}>
                    </div>
                ) : livePhase === 'speaking' ? (
                    <div className="w-12 h-12 rounded-full flex items-center justify-center mb-6 animate-pulse border shadow-lg" style={{ backgroundColor: 'color-mix(in srgb, var(--accent-primary, #4287f5) 10%, transparent)', borderColor: 'color-mix(in srgb, var(--accent-primary, #4287f5) 30%, transparent)', color: 'var(--accent-primary, #4287f5)' }}>
                    ...
                    <div className="w-full space-y-4">
                        {livePhase === 'idle' && (
                            <button 
                                ...
                                className="w-full py-3 text-white font-bold rounded-lg shadow-lg hover:bg-opacity-90 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2"
