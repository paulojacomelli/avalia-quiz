...
export const LOADING_MESSAGES = [
  ...
  "Sua curiosidade é o seu melhor guia. Continue aprendendo!",
  "Carregando novos desafios intelectuais...",
  "Recuperando informações... Tente lembrar o que você leu hoje!",
  "Dica Pro: A perseverança nos estudos traz grandes recompensas."
];
